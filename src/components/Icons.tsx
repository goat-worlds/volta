...
export function IconStar({ filled = false, className = '' }: { filled?: boolean; className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2">
      <polygon points="12 2 15.09 10.26 24 10.27 17.55 16.73 19.64 25 12 19.54 4.36 25 6.45 16.73 0 10.27 8.91 10.26 12 2"></polygon>
    </svg>
  )
}
...
export function IconShield({ className = '' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <polyline points="10 14.5 12 16.5 16 11"></polyline>
    </svg>
  )
}
...
export function IconHandshake({ className = '' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M17 12h-5v2h5v-2Z"></path>
      <path d="M7 12h5v2H7v-2Z"></path>
      <path d="M6 9c-1 0-2 1-2 2v3c0 1 1 2 2 2h2v-2H6v-3h2V9H6Z"></path>
      <path d="M18 9c1 0 2 1 2 2v3c0 1-1 2-2 2h-2v-2h2v-3h-2V9h2Z"></path>
    </svg>
  )
}
...
export function IconHourglass({ className = '' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M6 2h12v7c0 2-1.5 3-3 3h-6c-1.5 0-3-1-3-3V2Z"></path>
      <path d="M6 22h12v-7c0-2-1.5-3-3-3h-6c-1.5 0-3 1-3 3v7Z"></path>
...
export function IconWrench({ className = '' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M15 3H9v2h6V3Z"></path>
      <path d="M3 9h2v6H3V9Z"></path>
      <path d="M19 9h2v6h-2V9Z"></path>
      <path d="M9 15h6v2H9v-2Z"></path>
...
export function IconAttachment({ className = '' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <path d="M2 11.5a10 10 0 0 0 19.8 4.3M22 12.5a10 10 0 0 0-19.8-4.2"></path>
    </svg>
  )
}
